...
subprocess.call("python parser_sml.py Examples/example4.txt")
...
subprocess.call("python threader.py Examples/example4.txt")
...
subprocess.call("python compiler.py Examples/example4.txt")