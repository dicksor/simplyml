...
_lr_productions = [
  ...
  ('expression -> IDENTIFIER','expression',1,'p_expression','parser_sml.py',62),
  ('expression -> expression ADD_OP expression','expression',3,'p_expression_op','parser_sml.py',66),
  ('expression -> expression MUL_OP expression','expression',3,'p_expression_op','parser_sml.py',67),
  ('expression -> expression COMP_OP expression','expression',3,'p_expression_op','parser_sml.py',68),
  ('assignation -> IDENTIFIER = expression','assignation',3,'p_assign','parser_sml.py',72),
  ('parameter -> expression','parameter',1,'p_parameter','parser_sml.py',76),
  ('parameter -> expression , parameter','parameter',3,'p_parameter','parser_sml.py',77),
  ('function -> IDENTIFIER ( parameter )','function',4,'p_function','parser_sml.py',84),
]
