...
_lr_productions = [
  ...
  ('structure -> IF expression { programme }','structure',5,'p_structure_if','parser_sml.py',35),
  ('structure -> BULLETEDLIST { programme }','structure',4,'p_structure_bulleted_list','parser_sml.py',39),
  ('structure -> ARRAY { programme }','structure',4,'p_structure_array','parser_sml.py',43),
  ('structure -> ARRAYHEADER { programme }','structure',4,'p_structure_array_header','parser_sml.py',47),
  ('structure -> ARRAYROW { programme }','structure',4,'p_structure_array_row','parser_sml.py',51),
  ('expression -> ( expression )','expression',3,'p_expression_paren','parser_sml.py',55),
  ('expression -> NUMBER','expression',1,'p_expression','parser_sml.py',59),
  ('expression -> STRING','expression',1,'p_expression','parser_sml.py',60),
  ('expression -> IDENTIFIER','expression',1,'p_expression','parser_sml.py',61),
  ('expression -> expression ADD_OP expression','expression',3,'p_expression_op','parser_sml.py',65),
  ('expression -> expression MUL_OP expression','expression',3,'p_expression_op','parser_sml.py',66),
  ('expression -> expression COMP_OP expression','expression',3,'p_expression_op','parser_sml.py',67),
  ('assignation -> IDENTIFIER = expression','assignation',3,'p_assign','parser_sml.py',71),
  ('parameter -> expression','parameter',1,'p_parameter','parser_sml.py',75),
  ('parameter -> expression , parameter','parameter',3,'p_parameter','parser_sml.py',76),
  ('function -> IDENTIFIER ( parameter )','function',4,'p_function','parser_sml.py',83),
]
