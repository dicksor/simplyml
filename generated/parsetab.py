...
_lr_productions = [
  ...
  ('structure -> IF expression { programme }','structure',5,'p_structure_if','parser.py',35),
  ('structure -> BULLETEDLIST { programme }','structure',4,'p_structure_bulleted_list','parser.py',39),
  ('structure -> ARRAY { programme }','structure',4,'p_structure_array','parser.py',43),
  ('structure -> ARRAYHEADER { programme }','structure',4,'p_structure_array_header','parser.py',47),
  ('structure -> ARRAYROW { programme }','structure',4,'p_structure_array_row','parser.py',51),
  ('expression -> ( expression )','expression',3,'p_expression_paren','parser.py',55),
  ('expression -> NUMBER','expression',1,'p_expression','parser.py',59),
  ('expression -> STRING','expression',1,'p_expression','parser.py',60),
  ('expression -> IDENTIFIER','expression',1,'p_expression','parser.py',61),
